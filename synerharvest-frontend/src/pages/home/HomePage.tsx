...
<section className="hero-section">
  ...
  <div className="hero-slideshow">
    <div className="slideshow-image slideshow-image-1" style={{ backgroundImage: `url(${hero8})` }}></div>
    ...
    <div className="slideshow-image slideshow-image-5" style={{ backgroundImage: `url(${hero13})` }}></div>
